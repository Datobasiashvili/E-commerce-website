    ...
    <>
      <div className="header-wrapper">
        <div className="header-component">
          ...
          <NavLink className="logo" onClick={() => navigate("/home")}>
            <svg
              id="logo-icon"
              xmlns="http://www.w3.org/2000/svg"
              height="24px"
            ...
            <p id="logo-title">Shopy</p>
          </NavLink>

          <Searchbar />

          <p>Order it now and get it within 15 min!</p>
          <div className="header-icons">
            <NavLink
              to="/favorites"
              className={({ isActive }) =>
                isActive ? "active-header-link" : "normal-header-link"
              }
            >
              {/* <svg
                id="favorite-icon"
